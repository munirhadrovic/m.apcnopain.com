...
<html>
	<head>
		...
		<title>Advanced Pain Consultants</title>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
		    <h1>Powered by <a href="http://mobilegrows.com/">MobileGrows</a> | <a href="http://apcnopain.com/" rel="external">Desktop Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
			  	...
			  	<div class="callbacks_container">
				    <ul class="rslides" id="slider4">
				      <li>
				        <img src="img/slider-images/medsym.jpg" alt="">
              ...
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Conditions</a>
                  </div>
              </div>

				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Treatments</a>
					</div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
		  ...
		  <h2>Nicholas Kondelis, M.D.</h2>
            <p>D.A.B.A., D.A.B.A-P.M., D.A.B.P.M., D.A.A.P.M.</p>
            <h3>BOARD CERTIFIED PAIN MANAGEMENT</h3>
            <p><b>Our doctors have over 20 years experience in pain management.
                    For your convenience, we are located at 312 N. York Rd, Elmhurst, IL 60126.
                    Call us now to schedule your consultation: (630) 607-1000.</b></p>
